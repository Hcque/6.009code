...
class TestTiny(unittest.TestCase):
    ...
    def test_in_1(self):
        self.setUp()
        result = lab.did_x_and_y_act_together(self.data, 2876, 1640)
        expected = True
        self.assertEqual(result, expected)
        
    def test_in_2(self):
        self.setUp()
        result = lab.did_x_and_y_act_together(self.data, 2876, 2876)
        expected = True
        self.assertEqual(result, expected)
    ...
    def test_becon_path(self):
        self.setUp()
        result = lab.get_bacon_path(self.data, 46866)
        expected = [4724, 2876, 1640, 46866]
        self.assertEqual(result, expected)
    
    def test_abtr_path(self):
        self.setUp()
        result = lab.get_path(self.data, 1532, 1640)
        expected = [1532, 4724, 2876, 1640]
        self.assertEqual(result, expected)
